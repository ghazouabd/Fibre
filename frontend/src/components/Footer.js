                    ...
                    <div className="grid sm:grid-cols-12 gap-5 py-8 md:py-12 border-t border-gray-200 lg:ml-11">
                        ...
                        <div className="col-span-12 lg:col-span-4">
                            <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                                <h3 className="font-bold text-4xl mb-4">FAST</h3>
                                <div className='text-md font-medium text-gray-600'>
                                    <h5>Fiber Optic Monitoring</h5>
                                    <p>123 Fiber Street,</p>
                                    <p>Tech City,</p>
                                    <p>Tunisia.</p>
                                </div>
                            </div>
                        ...
                        <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                            ...
                            <ul className="text-md">
                                <li className="mb-2">
                                    <Link to="/rtu-management" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">RTU Management</Link>
                                </li>
                                <li className="mb-2">
                                    <Link to="/network-performance" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Network Performance</Link>
                                </li>
                                <li className="mb-2">
                                    <Link to="/fault-detection" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Fault Detection</Link>
                                </li>
                                <li className="mb-2">
                                    <Link to="/historical-data" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Historical Data</Link>
                                </li>
                            </ul>
                        </div>
