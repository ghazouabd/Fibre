  ...
  <span className="home-text">Accueil</span>
        ...
        <nav className="menu">
          <ul>
            ...
            <li className={location.pathname === "/configurationRTU" ? "active" : ""}>
              <Link to="/configurationRTU">Configuration</Link>
            </li>
           
            <li className={location.pathname === "/StateRTU" ? "active" : ""}>
              <Link to="/StateRTU">State</Link>
            </li>
