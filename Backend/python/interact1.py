...
class FiberAnalyzer(QMainWindow):
    def __init__(self):
        ...
        self.email_config = {
            ...
            'smtp_port': 587,
            'smtp_username': 'ghazouabedoui05@gmail.com',  # Replace with your email
            'smtp_password': 'ebofjpmfmsfgvomp',     # Use app password for Gmail
    ...
    def send_email_notification(self, alarm_data, pdf_path=None):
            ...
            try:
                ...
                msg['From'] = self.email_config['smtp_username']  # Simplified From field
        ...
        <html>
        <body>
            <h2>ALERTE: Détection de défaut fibre optique</h2>
            ...
            <table border="1" cellpadding="5" cellspacing="0">
                ...
                <tr><td><strong>Sévérité:</strong></td><td>{alarm_data['severity']}</td></tr>
        ...
        """
                ...
                print(f"Server: {self.email_config['smtp_server']}:{self.email_config['smtp_port']}")
                print(f"Username: {self.email_config['smtp_username']}")
    ...
    def on_click(self, event):
        ...
        if min_dist > 100 and abs(y_data[min_dist_idx] - click_y) > 1.0:
            return
            ...
            if self.reference_curve is not None:
                ...
                for name, value in sorted(self.thresholds.items(), key=lambda x: x[1], reverse=True):
                    if diff < -value:
                        ...
                        if hasattr(self, 'send_alarm_notification'):
                            self.send_alarm_notification(alarm_data)
                        ...
                        self.send_email_notification(alarm_data, pdf_path)
                        ...
                        QMessageBox.information(
                            ...
                            f"Notification email sent to monitoring team."
                        )
                        break
    ...
    def GetNext(self, key):
        """Helper method to get next section (copied from sorReader)"""
